      ...
      <section className="py-12 bg-white">
        <div className="container max-w-3xl">
          <div className="prose-legal space-y-6 text-gray-600 text-sm leading-relaxed">
            <div>
              <h2 className="text-lg font-bold text-[#040c1c] mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>1. Information We Collect</h2>
            ...
            <div>
              <h2 className="text-lg font-bold text-[#040c1c] mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>2. How We Use Your Information</h2>
            ...
            <div>
              <h2 className="text-lg font-bold text-[#040c1c] mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>3. Information Sharing</h2>
            ...
            <div>
              <h2 className="text-lg font-bold text-[#040c1c] mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>4. Data Security</h2>
              <p>We implement appropriate technical and organizational measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the Internet is 100% secure.</p>
            </div>
            <div>
              <h2 className="text-lg font-bold text-[#040c1c] mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>5. Cookies</h2>
            ...
            <div>
              <h2 className="text-lg font-bold text-[#040c1c] mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>6. Contact Us</h2>
