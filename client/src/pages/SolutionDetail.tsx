...
const SOLUTION_HOW_IT_WORKS: Record<string, { step: string; title: string; desc: string }[]> = {
  ...
  "dual-pricing": [
    { step: "01", title: "Program Selection", desc: "We review your business type, card mix, and customer base to recommend the right program — cash discount, surcharging, or cash discount & surcharging." },
...
const solutionsData: SolutionData[] = [
  {
    ...
    metaDescription: "Utah credit card processing with cash discounting, cash discount & surcharging & surcharging options. Eliminate processing fees, get next-day funding & local support.",
    ...
    features: [
      { title: "Flexible Pricing Models", desc: "We structure pricing around your specific business needs. Options include flat rate, tiered, and pass-through pricing models — as well as cost-reduction programs like cash discount & surcharging, surcharging, and cash discounting that can significantly lower or eliminate your processing costs." },
    ...
    faqs: [
      { question: "What credit card processing rates do you offer?", answer: "We tailor pricing to each business individually — there is no single rate that applies to everyone. Factors like your industry, monthly volume, average ticket size, and card mix all influence the best pricing structure for your account. We offer flat rate, tiered, and pass-through pricing models. We can also structure your account for surcharging, cash discount & surcharging, or cash discounting programs that shift processing costs to the cardholder — legally and compliantly — which can reduce or eliminate your out-of-pocket processing expense entirely. We'll walk you through every option and show you a clear cost comparison before you make any decision." },
      { question: "What is cash discount & surcharging and how is it different from surcharging?", answer: "Dual pricing displays two prices at the point of sale — one for cash and one for card — so customers can see the difference and choose their preferred payment method. Surcharging adds a fee to credit card transactions at checkout. Cash discounting posts a single (card) price and then applies a discount when the customer pays with cash. All three approaches are designed to offset processing costs, but they operate differently and have distinct compliance requirements. Dual pricing and cash discounting apply to all card types; surcharging is limited to credit cards only and is prohibited in certain states. We'll help you determine which model is right for your business and ensure you're fully compliant." },
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Applies to All Card Types (Cash Discount & Surcharging)", desc: "Cash discounting and cash discount & surcharging recover costs on every card transaction — credit, debit, and prepaid. Surcharging is limited to credit cards only. We'll help you choose the program that gives you the broadest cost recovery for your specific card mix." },
      { title: "No Monthly Program Fees", desc: "Our cash discount & surcharging programs are available with no monthly program fees for qualifying accounts. You recover processing costs without adding new overhead to your operating budget." },
    ...
    benefits: [
      ...
      "Cash discounting and cash discount & surcharging legal in all 50 states",
