...
const SOLUTION_STATS: Record<string, { value: string; label: string }[]> = {
  ...
  "high-risk-processing": [
    { value: "Dedicated", label: "Underwriting Support" },
...
const solutionsData: SolutionData[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Applies to All Card Types (Dual Pricing & Cash Discount Solutions)", desc: "Dual Pricing & Cash Discount solutions recover costs on every card transaction — credit, debit, and prepaid. Surcharging is limited to credit cards only. We'll help you choose the program that gives you the broadest cost recovery for your specific card mix." },
      { title: "No Monthly Program Fees", desc: "Our Dual Pricing & Cash Discount solutions are available with no monthly program fees for qualifying accounts. You recover processing costs without adding new overhead to your operating budget." },
    ...
    faqs: [
      ...
      { question: "What is the difference between Dual Pricing, Cash Discount & Surcharging?", answer: "Cash discounting posts one price and applies a discount when the customer pays with cash or non-card payment methods — the customer feels rewarded rather than penalized. Surcharging adds a fee to credit card transactions at checkout — the customer sees the fee added to their total. Dual pricing shows two prices upfront (cash and card) before the transaction begins. Dual pricing & cash discount solutions apply to all card types and are legal everywhere; surcharging is limited to credit cards and is prohibited in certain states. For most businesses, dual pricing & cash discount solutions is the most customer-friendly and compliant option." },
      { question: "Is Cash Discount compliant in Utah?", answer: "Yes. Cash discount programs are fully compliant in Utah and in all 50 states. There are no state-level restrictions on cash discounting or dual pricing programs. The key requirement is proper disclosure — customers must be clearly informed of the pricing structure before completing the transaction. We provide all required signage, receipt language, and disclosure materials as part of every program setup." },
      ...
      { question: "Do I need new equipment for a cash discount or surcharge program?", answer: "Equipment compatibility is evaluated on a case-by-case basis. Not all terminals and POS systems are certified to support cash discount, dual pricing, or surcharging programs — and using non-compliant hardware can put your program at risk. We assess your existing setup during the consultation to determine whether it meets the technical and compliance standards required for your chosen program. In many cases, existing equipment can be reprogrammed at no charge. Where new hardware is needed, we configure it for your program — often at no upfront cost for qualifying accounts." },
    ],
  ...
  },
  {
    ...
    heroPoints: ["Dedicated underwriting support for your vertical", "Competitive rates for high-risk accounts", "Rolling reserve minimized or waived for qualified merchants", "Multiple acquiring bank relationships"],
    features: [
    ...
    faqs: [
      ...
      { question: "How long does approval take for a high-risk account?", answer: "Approval timelines for high-risk merchant accounts vary depending on your vertical, processing history, and the acquiring bank. Some accounts are approved in a matter of days; others require a more thorough underwriting review that can take one to two weeks or longer. The bank will evaluate your business model, chargeback history, website, and supporting documentation. We guide you through every step, help you prepare the strongest possible application, and keep you informed throughout the process so there are no surprises." },
  ...
  },
  {
    slug: "dual-pricing",
    icon: "💵",
    title: "Dual Pricing for Utah Businesses",
    metaTitle: "Dual Pricing Programs for Utah Merchants | UBC Unlimited",
    metaDescription: "Dual pricing programs for Utah businesses — display cash and card prices side by side, eliminate processing fees legally. Free setup consultation with local support.",
    subtitle: "Display two prices at the point of sale — let customers choose, and stop paying processing fees out of pocket",
    description: "Dual pricing is one of the most transparent and customer-friendly ways to eliminate credit card processing costs. Instead of hiding the cost of card acceptance in your prices or surprising customers with a fee at checkout, dual pricing displays two prices side by side at the point of sale: a lower cash price and a standard card price. Customers see both options before the transaction begins and choose how they want to pay.\n\nFor Utah businesses, dual pricing is fully legal and compliant with Visa, Mastercard, and Discover card brand rules. There are no state-level restrictions on dual pricing programs in Utah. The key requirement is proper disclosure — customers must see both prices clearly before completing the transaction — and UBC Unlimited provides all required signage, receipt language, and customer-facing disclosures as part of every program setup.\n\nDual pricing works differently from surcharging and traditional cash discounting. Surcharging adds a fee to credit card transactions at checkout — the customer sees the fee added to their total after they've already decided to pay by card. Cash discounting posts a single price and applies a discount for cash payment. Dual pricing shows both prices upfront, giving customers a genuine choice before they commit to a payment method. Most customers find this approach the most transparent and least surprising.\n\nThe program is compatible with most modern POS systems and countertop terminals. In many cases, your existing equipment can be reprogrammed to support dual pricing at no charge. Where new hardware is needed, UBC Unlimited configures it for your program before it ships — often at no upfront cost for qualifying accounts.\n\nUBC Unlimited serves businesses across Utah — from Salt Lake City and Provo to St. George and Logan — with local setup, training, and ongoing support. Our team handles every aspect of the implementation: compliance review, hardware configuration, staff training, and compliant signage. We also provide a monthly savings report so you can see exactly how much the program is saving your business.",
    heroPoints: ["Legal in all 50 states", "Two prices displayed upfront — no surprise fees", "Compatible with most POS systems & terminals", "Compliant signage & receipt language included"],
    features: [
      { title: "Two-Price Display at Point of Sale", desc: "Your POS or terminal displays both a cash price and a card price simultaneously — before the customer selects a payment method. This transparency is the defining feature of dual pricing and the reason most customers respond positively to it. There's no surprise fee, no post-transaction adjustment — just a clear, honest choice." },
      { title: "Legal in All 50 States", desc: "Dual pricing is fully compliant with Visa, Mastercard, and Discover card brand rules and legal in all 50 states. Unlike surcharging, which is prohibited in a small number of states and restricted to credit cards only, dual pricing has no state-level restrictions and applies to credit, debit, and prepaid cards." },
      { title: "Compliant Signage & Receipt Language", desc: "Every dual pricing program requires specific customer-facing disclosures — at the entrance, at the point of sale, and on the receipt. We provide professionally designed signage templates and pre-configured receipt language that meet all card brand and regulatory requirements. You're covered from day one." },
      { title: "Compatible Hardware & POS Systems", desc: "Dual pricing requires a POS or terminal that can display both prices, print compliant receipts, and report cash and card transactions separately. We assess your existing equipment during the consultation and reprogram it at no charge in most cases. Where new hardware is needed, we configure it for your program before delivery." },
      { title: "Applies to All Card Types", desc: "Unlike surcharging, dual pricing applies to credit, debit, and prepaid cards — giving you the broadest possible cost recovery across your entire card mix. For businesses with a high proportion of debit card transactions, this is a significant advantage over surcharge-only programs." },
      { title: "No Monthly Program Fees", desc: "Dual pricing programs are available with no monthly program fees for qualifying accounts. You recover processing costs without adding new overhead to your operating budget." },
      { title: "Staff Training & Onboarding", desc: "A well-trained team is essential for a smooth customer experience. We provide training materials, talking points, and onboarding support so your staff can explain the program confidently and professionally — and handle the occasional customer question without friction." },
      { title: "Monthly Savings Reporting", desc: "See exactly how much your program is saving you every month — cash vs. card splits, total fees recovered, and program performance — all from your reporting dashboard." },
    ],
    benefits: [
      "Eliminate credit card processing fees on cash transactions",
      "Fully legal and compliant in all 50 states including Utah",
      "Applies to credit, debit, and prepaid cards",
      "Transparent customer experience — two prices shown upfront",
      "Compliant signage and receipt language provided",
      "Compatible with most existing terminals and POS systems",
      "No monthly program fees for qualifying accounts",
      "Local Utah setup, training, and ongoing support",
    ],
    faqs: [
      { question: "What is dual pricing and how does it work?", answer: "Dual pricing displays two prices at the point of sale simultaneously — a lower cash price and a standard card price. Customers see both options before they choose a payment method. If they pay with cash, they pay the lower price. If they pay with a card, they pay the standard price, which reflects the cost of card acceptance. There's no surprise fee added at checkout — the customer makes an informed choice upfront." },
      { question: "Is dual pricing legal in Utah?", answer: "Yes. Dual pricing is fully legal in Utah and in all 50 states. There are no state-level restrictions on dual pricing programs. The program is also compliant with Visa, Mastercard, and Discover card brand rules. The key requirement is proper disclosure — customers must see both prices clearly before completing the transaction. UBC Unlimited provides all required signage and receipt language as part of every program setup." },
      { question: "How is dual pricing different from surcharging?", answer: "Surcharging adds a fee to credit card transactions at checkout — the customer sees the fee added to their total after they've already decided to pay by card. Dual pricing shows both prices upfront, before the customer selects a payment method, so there's no surprise. Dual pricing also applies to all card types (credit, debit, and prepaid), while surcharging is limited to credit cards only and is prohibited in a small number of states." },
      { question: "Do I need new equipment for dual pricing?", answer: "Not necessarily. Many modern terminals and POS systems can be reprogrammed to support dual pricing at no charge. We assess your existing setup during the consultation to determine compatibility. Where new hardware is needed, we configure it for your program before delivery — often at no upfront cost for qualifying accounts." },
      { question: "How much can I save with dual pricing?", answer: "Savings depend on your monthly processing volume, card mix, and how many customers shift to cash payment. For many businesses, dual pricing eliminates 60–100% of card processing costs on cash transactions. We'll provide a clear cost-benefit analysis based on your actual processing history before you make any decision." },
    ],
    relatedSolutions: ["/solutions/surcharge-cash-discount", "/solutions/credit-card-processing", "/solutions/pos-systems"],
  },
];
