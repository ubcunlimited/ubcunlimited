...
const solutionsData: SolutionData[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How much does high-risk processing cost?", answer: "High-risk processing is more expensive than standard processing. Typical rates range from 3.5% to 5.5% per transaction, with monthly account fees of $25–$100 and chargeback fees of $25–$50 per dispute. Some accounts also require a rolling reserve of 5%–10% of daily transactions held for 90–180 days. The exact cost depends on your industry, monthly volume, chargeback history, and the acquiring bank we place you with. We provide a full, itemized fee disclosure before you sign anything." },
      { question: "What is a rolling reserve and how does it work?", answer: "A rolling reserve is a risk management tool used by acquiring banks for high-risk merchant accounts. A percentage of your daily transaction volume — typically 5%–10% — is held in a non-interest-bearing reserve account for a set period, usually 90–180 days. After the hold period, the funds are released on a rolling basis. The reserve protects the bank against potential chargebacks or account closure losses. We negotiate reserve requirements on your behalf and work to reduce or eliminate the reserve as your account establishes a clean processing history." },
