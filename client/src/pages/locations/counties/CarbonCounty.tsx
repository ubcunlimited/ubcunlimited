// Carbon County — Dedicated Local SEO Landing Page
// Target keywords: merchant services Carbon County, credit card processing Carbon County Utah, payment processing Price
...
export default function CarbonCounty() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "UBC Unlimited — Carbon County Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout Carbon County, Utah.",
    url: `https://ubcunlimited.com/locations/carbon-county`,
    ...
    geo: { "@type": "GeoCoordinates", latitude: 39.6536, longitude: -110.5898 },
    areaServed: { "@type": "AdministrativeArea", name: "Carbon County, Utah" },
    openingHoursSpecification: [{ "@type": "OpeningHoursSpecification", dayOfWeek: ["Monday","Tuesday","Wednesday","Thursday","Friday"], opens: "08:00", closes: "18:00" }],
    priceRange: "$$",
  };

  const cities = ["Price", "Helper", "East Carbon", "Wellington", "Sunnyside", "Kenilworth", "Carbonville", "Spring Glen", "Woodside", "Soldier Summit"];
  const industries = ["Restaurants", "Retail", "Mining", "Automotive", "Professional Services", "Agricultural Services"];

  return (
    <PageLayout>
      <SEO
        title="Merchant Services Carbon County, Utah | UBC Unlimited"
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to businesses throughout Carbon County, Utah. Local support, no contracts*, statement review."
        canonical="/locations/carbon-county"
        schema={schema}
      />
          ...
          <div className="max-w-3xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-1.5 text-xs text-white/35 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">Carbon County</span>
              </nav>
              <span className="inline-flex items-center gap-2 bg-[#c9a84c]/12 border border-[#c9a84c]/25 text-[#c9a84c] text-xs font-semibold px-4 py-1.5 rounded-full mb-5">
                <MapPin size={12} /> Carbon County, Utah
              </span>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2.5">
              ...
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />East Carbon</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Wellington</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Sunnyside</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Kenilworth</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Carbonville</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Spring Glen</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Woodside</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Soldier Summit</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { icon: MapPin, title: "Truly Local — Utah Based", desc: "We're not a national call center. UBC Unlimited serves Carbon County businesses with a local rep who knows the Utah market." },
              { icon: TrendingDown, title: "Lower Rates Than National Processors", desc: "Most Carbon County businesses overpay Stripe, Square, or their bank. Our statement review shows you exactly where you can save." },
              { icon: Clock, title: "Approved & Processing in 24–48 Hours", desc: "Most Carbon County businesses are live and processing within one to two business days. We handle setup, equipment, and training." },
              ...
              { icon: DollarSign, title: "Surcharge & Cash Discount Solutions Available", desc: "Eliminate processing fees entirely with our cash discount program — popular with Carbon County restaurants, retail, and service businesses." },
            ].map((benefit, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-3">
            {[
              { q: "Does UBC Unlimited serve businesses in Carbon County?", a: "Yes — UBC Unlimited serves businesses throughout Carbon County, including Price and all surrounding communities. We offer on-site consultations and local support." },
              { q: "How much does merchant services cost for a Carbon County business?", a: "Rates are tailored to your card mix and volume. Most Carbon County businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a statement review to show your exact savings." },
              { q: "What POS systems do you offer for Carbon County businesses?", a: "We offer SkyTab (ideal for restaurants and bars), Clover (popular with retail and professional services), and several other systems. We handle delivery, setup, and training — typically within 24–48 hours of approval." },
              { q: "Do you offer a cash discount program for Carbon County businesses?", a: "Yes. Utah law permits cash discount programs, which allow businesses to pass the processing fee to card-paying customers. This effectively eliminates your processing costs. We handle the full setup and compliance documentation." },
              { q: "How quickly can a Carbon County business get approved and start processing?", a: "Most Carbon County businesses are approved and live within 24–48 hours. We handle the setup, equipment, and training so you can focus on running your business." },
            ].map((faq, i) => (
      ...
      <CTABanner
        title="Ready to Lower Your Processing Costs in Carbon County?"
        subtitle="Get a statement review and see exactly how much your Carbon County business can save. Most businesses find meaningful savings on their processing costs after a statement review."
