...
export default function CarbonCounty() {
  ...
  return (
    <PageLayout>
      <SEO
        title="Merchant Services Carbon County, Utah"
        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "What POS systems do you offer for Carbon County businesses?", a: "We offer Shift4Dine (ideal for restaurants and bars), Clover (popular with retail and professional services), and several other systems. We handle delivery, setup, and training — typically within 24–48 hours of approval." },
