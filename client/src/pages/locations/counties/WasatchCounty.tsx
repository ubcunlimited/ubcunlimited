...
export default function WasatchCounty() {
  ...
  return (
    <PageLayout>
      <SEO
        title="Merchant Services Wasatch County, Utah | UBC Unlimited"
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to businesses throughout Wasatch County, Utah. Local support, no contracts, free statement review."
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/50 text-base leading-relaxed mb-8">UBC Unlimited serves every city and community in Wasatch County with credit card processing, POS systems, cash discount programs, and merchant accounts — backed by local Utah support that national processors can't match.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-500 text-base mb-8">UBC Unlimited provides on-site consultations and local support to businesses throughout Wasatch County, including the following communities:</p>
      ...
      <section className="py-20 bg-[#f8fafc]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in Wasatch County with tailored payment solutions and local support.</p>
          </div>
          <div className="flex flex-wrap justify-center gap-2.5">
        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: TrendingDown, title: "Lower Rates Than National Processors", desc: "Most Wasatch County businesses overpay Stripe, Square, or their bank. Our free statement review shows you exactly where you can save." },
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-base">Common questions from Wasatch County business owners about merchant services.</p>
          </div>
      ...
      <CTABanner
        ...
        subtitle="Get a free statement review and see exactly how much your Wasatch County business can save. Most businesses save 20–40% on processing fees."
