  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to businesses throughout San Juan County, Utah. Local support, no contracts, free statement review."
        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: TrendingDown, title: "Lower Rates Than National Processors", desc: "Most San Juan County businesses overpay Stripe, Square, or their bank. Our free statement review shows you exactly where you can save." },
      ...
      <CTABanner
        ...
        subtitle="Get a free statement review and see exactly how much your San Juan County business can save. Most businesses save 20–40% on processing fees."
