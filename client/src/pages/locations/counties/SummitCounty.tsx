        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: DollarSign, title: "Surcharging & Cash Discount Available", desc: "Eliminate processing fees entirely with our cash discount program — popular with Summit County restaurants, retail, and service businesses." },
            ].map((benefit, i) => (
