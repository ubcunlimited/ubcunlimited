      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-500 text-base mb-8">UBC Unlimited provides on-site consultations and local support to businesses throughout Summit County, including the following communities:</p>
      ...
      <section className="py-20 bg-[#f8fafc]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in Summit County with tailored payment solutions and local support.</p>
          </div>
          <div className="flex flex-wrap justify-center gap-2.5">
        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: DollarSign, title: "Surcharge & Cash Discount Solutions Available", desc: "Eliminate processing fees entirely with our cash discount program — popular with Summit County restaurants, retail, and service businesses." },
            ].map((benefit, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-base">Common questions from Summit County business owners about merchant services.</p>
          </div>
