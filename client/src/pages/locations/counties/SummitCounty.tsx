// Summit County — Dedicated Local SEO Landing Page
// Target keywords: merchant services Summit County, credit card processing Summit County Utah, payment processing Coalville
...
export default function SummitCounty() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "UBC Unlimited — Summit County Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout Summit County, Utah.",
    url: `https://ubcunlimited.com/locations/summit-county`,
    ...
    geo: { "@type": "GeoCoordinates", latitude: 40.8658, longitude: -111.0796 },
    areaServed: { "@type": "AdministrativeArea", name: "Summit County, Utah" },
    openingHoursSpecification: [{ "@type": "OpeningHoursSpecification", dayOfWeek: ["Monday","Tuesday","Wednesday","Thursday","Friday"], opens: "08:00", closes: "18:00" }],
    priceRange: "$$",
  };

  const cities = ["Park City", "Coalville", "Kamas", "Henefer", "Oakley", "Francis", "Peoa", "Wanship", "Hoytsville", "Echo"];
  const industries = ["Restaurants", "Retail", "Hotels", "Outdoor Recreation", "Professional Services", "Real Estate"];

  return (
    <PageLayout>
      <SEO
        title="Merchant Services Summit County, Utah"
          ...
          <div className="max-w-3xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center justify-center gap-1.5 text-xs text-white/60 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">Summit County</span>
              </nav>
              <span className="inline-flex items-center gap-2 bg-[#c9a84c]/12 border border-[#c9a84c]/25 text-[#c9a84c] text-xs font-semibold px-4 py-1.5 rounded-full mb-5">
                <MapPin size={12} /> Summit County, Utah
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-5 leading-tight">
                Merchant Services<br /><span className="text-[#c9a84c]">Summit County</span>
              </h1>
              ...
              <p className="text-white/70 text-base leading-relaxed mb-8">UBC Unlimited serves every city and community in Summit County with credit card processing, POS systems, cash discount programs, and merchant accounts — backed by local Utah support that national processors can't match.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-3">Cities & Communities We Serve in Summit County</h2>
            <p className="text-gray-600 text-base mb-8">UBC Unlimited provides on-site consultations and local support to businesses throughout Summit County, including the following communities:</p>
            <div className="flex flex-wrap justify-center gap-2.5">
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Park City</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Coalville</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Kamas</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Henefer</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Oakley</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Francis</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Peoa</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Wanship</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Hoytsville</span>
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><MapPin size={12} className="text-[#c9a84c]" />Echo</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#f8fafc]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#080808] mb-3">Industries We Serve in Summit County</h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in Summit County with tailored payment solutions and local support.</p>
          </div>
          <div className="flex flex-wrap justify-center gap-2.5">
              ...
              <span className="inline-flex items-center gap-1.5 bg-white border border-gray-200 text-[#080808] text-sm font-medium px-4 py-2 rounded-full shadow-sm"><Building2 size={12} className="text-[#c9a84c]" />Real Estate</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Why Summit County Businesses Choose UBC Unlimited</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: DollarSign, title: "Cash Discount & Dual Pricing Available", desc: "Eliminate processing fees entirely with our cash discount program — popular with Summit County restaurants, retail, and service businesses." },
            ].map((benefit, i) => (
      ...
      <section className="py-20 bg-white">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-2">Frequently Asked Questions — Summit County</h2>
            <p className="text-gray-600 text-base">Common questions from Summit County business owners about merchant services.</p>
          </div>
          <div className="space-y-3">
            {[
              ...
              { q: "What POS systems do you offer for Summit County businesses?", a: "We offer Shift4Dine (ideal for restaurants and bars), Clover (popular with retail and professional services), and several other systems. We handle delivery, setup, and training — typically within 24–48 hours of approval." },
      ...
      <CTABanner
        ...
        subtitle="Get a statement review and see exactly how much your Summit County business can save. Most businesses find meaningful savings on their processing costs after a statement review."
