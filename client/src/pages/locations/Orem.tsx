// Orem — Dedicated Local SEO Landing Page
// Target keywords: merchant services Orem, credit card processing Orem, payment processing Orem Utah
...
const OREM_INDUSTRIES = [
  ...
  },
  {
    ...
    desc: "Orem medical practices and clinics benefit from HIPAA-aware payment workflows and patient-friendly billing solutions.",
    href: "/industries/medical",
  },
  {
    icon: Wrench,
    name: "Automotive Services",
    desc: "Orem auto shops and service centers use our terminals and mobile processing for fast, reliable payment collection.",
    href: "/industries/automotive",
  },
  {
    icon: Hotel,
    name: "Salons & Spas",
    desc: "Orem salons and spas use our POS systems for appointment-based checkout, tip management, and gift card programs.",
    href: "/industries/salons-spas",
  },
  {
    icon: Building2,
    name: "Professional Services",
    desc: "Law firms, accountants, and consultants in Orem use our virtual terminals and invoicing to get paid faster.",
...
const OREM_BENEFITS = [
  {
    ...
    desc: "We're not a national call center. UBC Unlimited serves Orem businesses with a local rep who knows the market and the unique needs of Utah businesses.",
  },
  {
    icon: TrendingDown,
    title: "Lower Rates Than National Processors",
    desc: "Most Orem businesses overpay Stripe, Square, or their bank. Our statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
    title: "Approved & Processing in 24–48 Hours",
    desc: "Most Orem businesses are live and processing within one to two business days. We handle the setup, equipment, and training so you don't have to.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "Eliminate processing fees entirely with our cash discount program — popular with Orem restaurants, retail, and service businesses looking to protect margins.",
  }
];

const OREM_FAQS = [
  {
    q: "Does UBC Unlimited serve businesses in Orem, Utah?",
    a: "Yes — UBC Unlimited serves businesses throughout Orem and Utah County, including the State Street retail corridor, the UVU campus area, and surrounding neighborhoods. We offer on-site consultations and local support.",
  },
  {
    q: "How much does merchant services cost for an Orem business?",
    a: "Rates are tailored to your card mix and volume. Most Orem businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a statement review to show your exact savings.",
  },
  {
  ...
  {
    q: "Can you help an Orem medical practice with payment processing?",
    a: "Absolutely. We specialize in HIPAA-aware payment workflows for medical practices, including patient-friendly billing, virtual terminals, and integration with practice management software.",
  },
  {
    q: "How quickly can an Orem business get approved and start processing?",
    a: "Most Orem businesses are approved and live within 24–48 hours. We handle the setup, equipment, and training so you can focus on running your business.",
  }
];

const OREM_NEIGHBORHOODS = [
...
const TESTIMONIALS = [
  {
    name: "Linda T.",
    business: "Retail Store Owner, State Street",
    rating: 5,
    text: "We were overpaying for years. UBC Unlimited reviewed our statement and got us on interchange-plus. We're saving over $300 a month now.",
  },
  {
    name: "Dr. Kevin S.",
    business: "Medical Practice, Orem",
    rating: 5,
    text: "The payment solution integrates perfectly with our billing software. Patients love the new checkout experience and our staff loves how easy it is to use.",
  },
  {
    name: "Maria G.",
    business: "Salon Owner, Orem",
    rating: 5,
    text: "The POS system handles appointments, tips, and gift cards all in one place. Setup was done in a day and the local support has been fantastic.",
  }
];
...
export default function Orem() {
  const schema = {
    ...
    "@type": "LocalBusiness",
    name: "UBC Unlimited — Orem Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout Orem, Utah.",
    url: `https://ubcunlimited.com/locations/orem`,
    ...
    geo: { "@type": "GeoCoordinates", latitude: 40.2969, longitude: -111.6946 },
    areaServed: [
      { "@type": "City", "name": "Orem" },
  ...
  return (
    <PageLayout>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-white/60 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">Orem</span>
              </nav>
              <span className="inline-flex items-center gap-1.5 bg-[#c9a84c]/10 border border-[#c9a84c]/25 text-[#c9a84c] text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-5">
                <MapPin size={11} /> Orem, Utah
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5">
                Merchant Services in{" "}
                <span className="text-[#c9a84c]">Orem</span>
              </h1>
              ...
              <p className="text-white/70 text-sm leading-relaxed mb-8 max-w-xl">From the retail corridor on State Street to the restaurants and medical practices near UVU, we help Orem businesses accept payments smarter, save on processing costs, and grow with confidence.</p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="space-y-4">
              <div className="bg-white/4 border border-white/10 rounded-2xl p-6">
                <h2 className="text-white font-bold text-base mb-4 flex items-center gap-2">
                  <MapPin size={16} className="text-[#c9a84c]" />Orem Market Overview
                </h2>
                <div className="grid grid-cols-2 gap-3">
                  {[{ label: "Population", value: "98,000+" },{ label: "County", value: "Utah County" },{ label: "State", value: "Utah" },{ label: "Support", value: "Local Rep" }].map((stat) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#080808] mb-3">Industries We Serve in Orem</h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the Orem market with tailored payment solutions.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {OREM_INDUSTRIES.map((industry, i) => (
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Why Orem Businesses Choose UBC Unlimited</h2>
            <p className="text-white/70 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why Orem business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {OREM_BENEFITS.map((benefit, i) => (
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-3">Serving Every Neighborhood in Orem</h2>
            <p className="text-gray-600 text-base mb-8">Whether your business is in the heart of Orem or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
            <div className="flex flex-wrap justify-center gap-2.5">
              {OREM_NEIGHBORHOODS.map((n) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-2">What Orem Business Owners Say</h2>
            <p className="text-gray-600 text-base">Real feedback from real businesses in the Orem area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Frequently Asked Questions — Orem</h2>
            <p className="text-white/70 text-base">Common questions from Orem business owners about merchant services.</p>
          </div>
      ...
      <CTABanner
        title="Ready to Lower Your Processing Costs in Orem?"
        subtitle="Get a statement review and see exactly how much your Orem business can save. Most businesses find meaningful savings on their processing costs after a statement review."
