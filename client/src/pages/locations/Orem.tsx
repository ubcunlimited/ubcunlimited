...
const OREM_BENEFITS = [
  ...
  },
  {
    ...
    desc: "Most Orem businesses overpay Stripe, Square, or their bank. Our free statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
...
const OREM_FAQS = [
  ...
  },
  {
    ...
    a: "Rates are tailored to your card mix and volume. Most Orem businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a free statement review to show your exact savings.",
  },
  {
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to Orem, Utah businesses. Local support, no contracts, free statement review."
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the Orem market with tailored payment solutions.</p>
          </div>
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/50 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why Orem business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-500 text-base mb-8">Whether your business is in the heart of Orem or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-base">Real feedback from real businesses in the Orem area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/50 text-base">Common questions from Orem business owners about merchant services.</p>
          </div>
      ...
      <CTABanner
        ...
        subtitle="Get a free statement review and see exactly how much your Orem business can save. Most businesses save 20–40% on processing fees."
