// Heber City — Dedicated Local SEO Landing Page
// Target keywords: merchant services Heber City, credit card processing Heber City, payment processing Heber City Utah
...
const HEBER_CITY_INDUSTRIES = [
  ...
  },
  {
    ...
    desc: "Heber Valley's outdoor recreation businesses — from ski resorts to equestrian centers — benefit from mobile processing and fast checkout solutions.",
    href: "/industries/hotels-hospitality",
  },
  {
    icon: Building2,
    name: "Professional Services",
    desc: "Law firms, accountants, and consultants in Heber City use our virtual terminals and invoicing to get paid faster.",
    href: "/industries/professional-services",
  },
  {
    icon: Wrench,
    name: "Automotive Services",
    desc: "Heber City auto shops and service centers use our terminals and mobile processing for fast, reliable payment collection.",
    href: "/industries/automotive",
  },
  {
    icon: Wrench,
    name: "Home Services & Contractors",
    desc: "Home service businesses in Heber City use our mobile processing to collect payment on-site, every time.",
    href: "/industries/home-services",
  }
];

const HEBER_CITY_BENEFITS = [
  {
    icon: MapPin,
    title: "Truly Local — Utah Based",
    desc: "We're not a national call center. UBC Unlimited serves Heber City businesses with a local rep who knows the market and the unique needs of Utah businesses.",
  },
  {
    icon: TrendingDown,
    title: "Lower Rates Than National Processors",
    desc: "Most Heber City businesses overpay Stripe, Square, or their bank. Our free statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
    title: "Approved & Processing in 24–48 Hours",
    desc: "Most Heber City businesses are live and processing within one to two business days. We handle the setup, equipment, and training so you don't have to.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "Eliminate processing fees entirely with our cash discount program — popular with Heber City restaurants, retail, and service businesses looking to protect margins.",
  }
];

const HEBER_CITY_FAQS = [
  {
    q: "Does UBC Unlimited serve businesses in Heber City, Utah?",
    a: "Yes — UBC Unlimited serves businesses throughout Heber City and Wasatch County, including downtown, the Heber Valley, and surrounding areas. We offer on-site consultations and local support.",
  },
  {
    q: "How much does merchant services cost for a Heber City business?",
    a: "Rates are tailored to your card mix and volume. Most Heber City businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a free statement review to show your exact savings.",
  },
  {
  ...
  {
    q: "Do you serve Midway businesses near Heber City?",
    a: "Yes — we serve the entire Wasatch County area including Midway, Daniel, Charleston, and surrounding communities in addition to Heber City itself.",
  },
  {
    q: "How quickly can a Heber City business get approved and start processing?",
    a: "Most Heber City businesses are approved and live within 24–48 hours. We handle the setup, equipment, and training so you can focus on running your business.",
  }
];

const HEBER_CITY_NEIGHBORHOODS = [
  "Downtown Heber City",
  "Midway Border",
  "Daniel",
  "Heber Valley",
...
const TESTIMONIALS = [
  ...
  {
    name: "Lisa M.",
    business: "Outdoor Recreation Business, Heber Valley",
    rating: 5,
    text: "The mobile reader is perfect for our outdoor events and on-site payment collection. Reliable, fast, and the processing rates are excellent.",
  },
  {
    name: "Mark T.",
    business: "Retail Store, Heber City",
    rating: 5,
    text: "Switched from Square and saved over $150 a month. The local support is excellent — our rep knows our business.",
  }
];

export default function HeberCity() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "UBC Unlimited — Heber City Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout Heber City, Utah.",
    url: `https://ubcunlimited.com/locations/heber-city`,
    ...
    areaServed: [
      { "@type": "City", "name": "Heber City" },
      { "@type": "City", "name": "Midway" },
      { "@type": "City", "name": "Daniel" },
      { "@type": "City", "name": "Charleston" },
      { "@type": "City", "name": "Wallsburg" }
    ],
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to Heber City, Utah businesses. Local support, no contracts, free statement review."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-white/35 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">Heber City</span>
              </nav>
              <span className="inline-flex items-center gap-1.5 bg-[#c9a84c]/10 border border-[#c9a84c]/25 text-[#c9a84c] text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-5">
                <MapPin size={11} /> Heber City, Utah
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5">
                Merchant Services in{" "}
                <span className="text-[#c9a84c]">Heber City</span>
              </h1>
              <p className="text-white/60 text-lg leading-relaxed mb-4 max-w-xl">UBC Unlimited serves Heber City businesses with credit card processing, POS systems, cash discount programs, and merchant accounts — with local Utah support that national processors can't match.</p>
              <p className="text-white/45 text-sm leading-relaxed mb-8 max-w-xl">From the restaurants and retailers of downtown Heber City to the outdoor recreation and tourism businesses of the Heber Valley, we help Wasatch County businesses accept payments smarter and save on processing costs.</p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="space-y-4">
              <div className="bg-white/4 border border-white/10 rounded-2xl p-6">
                <h2 className="text-white font-bold text-base mb-4 flex items-center gap-2">
                  <MapPin size={16} className="text-[#c9a84c]" />Heber City Market Overview
                </h2>
                <div className="grid grid-cols-2 gap-3">
                  {[{ label: "Population", value: "16,000+" },{ label: "County", value: "Wasatch County" },{ label: "State", value: "Utah" },{ label: "Support", value: "Local Rep" }].map((stat) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#080808] mb-3">Industries We Serve in Heber City</h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the Heber City market with tailored payment solutions.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {HEBER_CITY_INDUSTRIES.map((industry, i) => (
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Why Heber City Businesses Choose UBC Unlimited</h2>
            <p className="text-white/50 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why Heber City business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {HEBER_CITY_BENEFITS.map((benefit, i) => (
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-3">Serving Every Neighborhood in Heber City</h2>
            <p className="text-gray-500 text-base mb-8">Whether your business is in the heart of Heber City or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
            <div className="flex flex-wrap justify-center gap-2.5">
              {HEBER_CITY_NEIGHBORHOODS.map((n) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-2">What Heber City Business Owners Say</h2>
            <p className="text-gray-500 text-base">Real feedback from real businesses in the Heber City area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Frequently Asked Questions — Heber City</h2>
            <p className="text-white/50 text-base">Common questions from Heber City business owners about merchant services.</p>
          </div>
          <div className="space-y-3">
            {HEBER_CITY_FAQS.map((faq, i) => (
      ...
      <CTABanner
        title="Ready to Lower Your Processing Costs in Heber City?"
        subtitle="Get a free statement review and see exactly how much your Heber City business can save. Most businesses save 20–40% on processing fees."
