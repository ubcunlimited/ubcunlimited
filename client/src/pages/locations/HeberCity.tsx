...
const HEBER_CITY_BENEFITS = [
  ...
  },
  {
    ...
    desc: "Most Heber City businesses overpay Stripe, Square, or their bank. Our statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
...
const HEBER_CITY_FAQS = [
  ...
  },
  {
    ...
    a: "Rates are tailored to your card mix and volume. Most Heber City businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a statement review to show your exact savings.",
  },
  {
  ...
  return (
    <PageLayout>
      ...
      <CTABanner
        ...
        subtitle="Get a statement review and see exactly how much your Heber City business can save. Most businesses find meaningful savings on their processing costs after a statement review."
