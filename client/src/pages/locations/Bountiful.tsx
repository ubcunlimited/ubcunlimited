// Bountiful — Dedicated Local SEO Landing Page
// Target keywords: merchant services Bountiful, credit card processing Bountiful, payment processing Bountiful Utah
...
const BOUNTIFUL_INDUSTRIES = [
  ...
  },
  {
    ...
    desc: "Bountiful medical practices benefit from HIPAA-aware payment workflows and patient-friendly billing solutions.",
    href: "/industries/medical",
  },
  {
    icon: Building2,
    name: "Professional Services",
    desc: "Law firms, accountants, and consultants in Bountiful use our virtual terminals and invoicing to get paid faster.",
    href: "/industries/professional-services",
  },
  {
    icon: Wrench,
    name: "Automotive Services",
    desc: "Bountiful auto shops and service centers use our terminals and mobile processing for fast, reliable payment collection.",
    href: "/industries/automotive",
  },
  {
    icon: Wrench,
    name: "Home Services & Contractors",
    desc: "Bountiful's established residential base drives strong demand for home services. Our mobile processing lets contractors collect payment on-site.",
    href: "/industries/home-services",
  }
];

const BOUNTIFUL_BENEFITS = [
  {
    icon: MapPin,
    title: "Truly Local — Utah Based",
    desc: "We're not a national call center. UBC Unlimited serves Bountiful businesses with a local rep who knows the market and the unique needs of Utah businesses.",
  },
  {
    icon: TrendingDown,
    title: "Lower Rates Than National Processors",
    desc: "Most Bountiful businesses overpay Stripe, Square, or their bank. Our free statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
    title: "Approved & Processing in 24–48 Hours",
    desc: "Most Bountiful businesses are live and processing within one to two business days. We handle the setup, equipment, and training so you don't have to.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "Eliminate processing fees entirely with our cash discount program — popular with Bountiful restaurants, retail, and service businesses looking to protect margins.",
  }
];

const BOUNTIFUL_FAQS = [
  {
    q: "Does UBC Unlimited serve businesses in Bountiful, Utah?",
    a: "Yes — UBC Unlimited serves businesses throughout Bountiful and Davis County, including the Orchard Drive corridor, downtown Bountiful, and surrounding areas. We offer on-site consultations and local support.",
  },
  {
    q: "How much does merchant services cost for a Bountiful business?",
    a: "Rates are tailored to your card mix and volume. Most Bountiful businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a free statement review to show your exact savings.",
  },
  {
  ...
  {
    q: "Do you serve North Salt Lake businesses near Bountiful?",
    a: "Yes — we serve the entire Davis County area including North Salt Lake, Woods Cross, Centerville, and surrounding communities in addition to Bountiful itself.",
  },
  {
    q: "How quickly can a Bountiful business get approved and start processing?",
    a: "Most Bountiful businesses are approved and live within 24–48 hours. We handle the setup, equipment, and training so you can focus on running your business.",
  }
];

const BOUNTIFUL_NEIGHBORHOODS = [
  "Downtown Bountiful",
  "Mueller Park",
  "Orchard Drive Corridor",
  "South Bountiful",
  "North Salt Lake Border",
  "Eaglewood",
  "Lakeview",
  "Sunset",
  "Bountiful Bench",
...
const TESTIMONIALS = [
  {
    name: "Linda H.",
    business: "Retail Store, Orchard Drive",
    rating: 5,
    text: "UBC Unlimited cut our processing costs by 25%. The local support is excellent — our rep knows our business and is always available.",
  },
  {
    name: "Dr. Paul S.",
    business: "Medical Practice, Bountiful",
    rating: 5,
    text: "The payment solution integrates with our billing software and patients love the modern checkout experience.",
  },
  {
    name: "Karen T.",
...
export default function Bountiful() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "UBC Unlimited — Bountiful Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout Bountiful, Utah.",
    url: `https://ubcunlimited.com/locations/bountiful`,
    ...
    geo: { "@type": "GeoCoordinates", latitude: 40.8894, longitude: -111.8808 },
    areaServed: [
      { "@type": "City", "name": "Bountiful" },
      { "@type": "City", "name": "North Salt Lake" },
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to Bountiful, Utah businesses. Local support, no contracts, free statement review."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-white/35 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">Bountiful</span>
              </nav>
              <span className="inline-flex items-center gap-1.5 bg-[#c9a84c]/10 border border-[#c9a84c]/25 text-[#c9a84c] text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-5">
                <MapPin size={11} /> Bountiful, Utah
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5">
                Merchant Services in{" "}
                <span className="text-[#c9a84c]">Bountiful</span>
              </h1>
              <p className="text-white/60 text-lg leading-relaxed mb-4 max-w-xl">UBC Unlimited serves Bountiful businesses with credit card processing, POS systems, cash discount programs, and merchant accounts — with local Utah support that national processors can't match.</p>
              <p className="text-white/45 text-sm leading-relaxed mb-8 max-w-xl">From the retail and restaurant corridor along Orchard Drive to the medical practices and professional services firms of this well-established Davis County community, we help Bountiful businesses accept payments smarter.</p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="space-y-4">
              <div className="bg-white/4 border border-white/10 rounded-2xl p-6">
                <h2 className="text-white font-bold text-base mb-4 flex items-center gap-2">
                  <MapPin size={16} className="text-[#c9a84c]" />Bountiful Market Overview
                </h2>
                <div className="grid grid-cols-2 gap-3">
                  {[{ label: "Population", value: "45,000+" },{ label: "County", value: "Davis County" },{ label: "State", value: "Utah" },{ label: "Support", value: "Local Rep" }].map((stat) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#080808] mb-3">Industries We Serve in Bountiful</h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the Bountiful market with tailored payment solutions.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {BOUNTIFUL_INDUSTRIES.map((industry, i) => (
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Why Bountiful Businesses Choose UBC Unlimited</h2>
            <p className="text-white/50 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why Bountiful business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {BOUNTIFUL_BENEFITS.map((benefit, i) => (
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-3">Serving Every Neighborhood in Bountiful</h2>
            <p className="text-gray-500 text-base mb-8">Whether your business is in the heart of Bountiful or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
            <div className="flex flex-wrap justify-center gap-2.5">
              {BOUNTIFUL_NEIGHBORHOODS.map((n) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-2">What Bountiful Business Owners Say</h2>
            <p className="text-gray-500 text-base">Real feedback from real businesses in the Bountiful area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Frequently Asked Questions — Bountiful</h2>
            <p className="text-white/50 text-base">Common questions from Bountiful business owners about merchant services.</p>
          </div>
          <div className="space-y-3">
            {BOUNTIFUL_FAQS.map((faq, i) => (
      ...
      <CTABanner
        title="Ready to Lower Your Processing Costs in Bountiful?"
        subtitle="Get a free statement review and see exactly how much your Bountiful business can save. Most businesses save 20–40% on processing fees."
