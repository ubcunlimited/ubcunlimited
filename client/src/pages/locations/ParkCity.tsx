// Park City — Dedicated Local SEO Landing Page
// Target keywords: merchant services Park City, credit card processing Park City, payment processing Park City Utah
...
const PARK_CITY_INDUSTRIES = [
  ...
  },
  {
    ...
    desc: "Park City's world-class hotels and vacation rentals need property management integrations and seamless guest payment experiences. We handle both.",
    href: "/industries/hotels-hospitality",
  },
  {
    icon: Hotel,
    name: "Ski Resorts & Outdoor Recreation",
    desc: "Park City Mountain Resort and Deer Valley ski shops, rental operations, and food service businesses benefit from our high-volume processing solutions.",
    href: "/industries/hotels-hospitality",
  },
  {
    icon: Building2,
    name: "Professional Services",
    desc: "Real estate agents, property managers, and professional services firms in Park City use our virtual terminals and invoicing to get paid faster.",
    href: "/industries/professional-services",
  },
  {
    icon: Hotel,
    name: "Spas & Wellness",
    desc: "Park City's luxury spas and wellness centers use our POS systems for appointment-based checkout, tip management, and retail sales.",
    href: "/industries/salons-spas",
  }
];

const PARK_CITY_BENEFITS = [
  {
    icon: MapPin,
    title: "Truly Local — Utah Based",
    desc: "We're not a national call center. UBC Unlimited serves Park City businesses with a local rep who knows the market and the unique needs of Utah businesses.",
  },
  {
    icon: TrendingDown,
    title: "Lower Rates Than National Processors",
    desc: "Most Park City businesses overpay Stripe, Square, or their bank. Our statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
    title: "Approved & Processing in 24–48 Hours",
    desc: "Most Park City businesses are live and processing within one to two business days. We handle the setup, equipment, and training so you don't have to.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "Eliminate processing fees entirely with our cash discount program — popular with Park City restaurants, retail, and service businesses looking to protect margins.",
  }
];

const PARK_CITY_FAQS = [
  {
    q: "Does UBC Unlimited serve businesses in Park City, Utah?",
    a: "Yes — UBC Unlimited serves businesses throughout Park City and Summit County, including Historic Main Street, Deer Valley, Kimball Junction, and surrounding areas. We offer on-site consultations and local support.",
  },
  {
    q: "How much does merchant services cost for a Park City business?",
    a: "Rates are tailored to your card mix and volume. Most Park City businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a statement review to show your exact savings.",
  },
  {
  ...
  {
    q: "Can you handle high-volume seasonal processing for Park City ski season?",
    a: "Absolutely. We specialize in high-volume processing solutions for seasonal businesses, including ski resorts, restaurants, and retail shops that see significant volume spikes during ski season and the Sundance Film Festival.",
  },
  {
    q: "How quickly can a Park City business get approved and start processing?",
    a: "Most Park City businesses are approved and live within 24–48 hours. We handle the setup, equipment, and training so you can focus on running your business.",
  }
];

const PARK_CITY_NEIGHBORHOODS = [
  "Historic Main Street",
  "Park City Mountain Resort Area",
  "Deer Valley",
  "Prospector",
  "Kimball Junction",
  "Snyderville Basin",
...
const TESTIMONIALS = [
  ...
  {
    name: "James H.",
    business: "Boutique Ski Shop, Deer Valley",
    rating: 5,
    text: "The Clover system handles retail sales, rentals, and repairs all in one place. UBC Unlimited made the transition seamless.",
  },
  {
    name: "Elena R.",
    business: "Luxury Spa, Park City",
    rating: 5,
    text: "Appointment booking, tip management, and retail sales all in one system. The local support is excellent and the processing rates are competitive.",
  }
];

export default function ParkCity() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "UBC Unlimited — Park City Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout Park City, Utah.",
    url: `https://ubcunlimited.com/locations/park-city`,
    ...
    geo: { "@type": "GeoCoordinates", latitude: 40.6461, longitude: -111.498 },
    areaServed: [
      { "@type": "City", "name": "Park City" },
      { "@type": "City", "name": "Deer Valley" },
      { "@type": "City", "name": "Kimball Junction" },
      { "@type": "City", "name": "Snyderville" },
      { "@type": "City", "name": "Jeremy Ranch" }
    ],
  ...
  return (
    <PageLayout>
      <SEO
        title="Merchant Services Park City, Utah | UBC Unlimited"
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to Park City, Utah businesses. Local support, no contracts*, statement review."
        canonical="/locations/park-city"
        schema={schema}
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-white/35 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">Park City</span>
              </nav>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="space-y-4">
              <div className="bg-white/4 border border-white/10 rounded-2xl p-6">
                <h2 className="text-white font-bold text-base mb-4 flex items-center gap-2">
                  <MapPin size={16} className="text-[#c9a84c]" />Park City Market Overview
                </h2>
      ...
      <CTABanner
        title="Ready to Lower Your Processing Costs in Park City?"
        subtitle="Get a statement review and see exactly how much your Park City business can save. Most businesses find meaningful savings on their processing costs after a statement review."
