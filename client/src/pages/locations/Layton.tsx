...
const LAYTON_BENEFITS = [
  ...
  },
  {
    ...
    desc: "Most Layton businesses overpay Stripe, Square, or their bank. Our free statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
...
const LAYTON_FAQS = [
  ...
  },
  {
    ...
    a: "Rates are tailored to your card mix and volume. Most Layton businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a free statement review to show your exact savings.",
  },
  {
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to Layton, Utah businesses. Local support, no contracts, free statement review."
      ...
      <CTABanner
        ...
        subtitle="Get a free statement review and see exactly how much your Layton business can save. Most businesses save 20–40% on processing fees."
