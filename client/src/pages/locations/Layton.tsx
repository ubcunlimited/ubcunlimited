// Layton — Dedicated Local SEO Landing Page
// Target keywords: merchant services Layton, credit card processing Layton, payment processing Layton Utah
...
const LAYTON_INDUSTRIES = [
  ...
  },
  {
    ...
    desc: "Layton auto shops and service centers use our terminals and mobile processing for fast, reliable payment collection.",
    href: "/industries/automotive",
  },
  {
    icon: Building2,
    name: "Professional Services",
    desc: "Law firms, accountants, and consultants in Layton use our virtual terminals and invoicing to get paid faster.",
    href: "/industries/professional-services",
  },
  {
    icon: Stethoscope,
    name: "Medical & Healthcare",
    desc: "Layton medical practices benefit from HIPAA-aware payment workflows and patient-friendly billing solutions.",
    href: "/industries/medical",
  },
  {
    icon: Wrench,
    name: "Home Services & Contractors",
    desc: "Layton's large residential base drives strong demand for home services. Our mobile processing lets contractors collect payment on-site.",
    href: "/industries/home-services",
  }
];

const LAYTON_BENEFITS = [
  {
    icon: MapPin,
    title: "Truly Local — Utah Based",
    desc: "We're not a national call center. UBC Unlimited serves Layton businesses with a local rep who knows the market and the unique needs of Utah businesses.",
  },
  {
    icon: TrendingDown,
    title: "Lower Rates Than National Processors",
    desc: "Most Layton businesses overpay Stripe, Square, or their bank. Our statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
    title: "Approved & Processing in 24–48 Hours",
    desc: "Most Layton businesses are live and processing within one to two business days. We handle the setup, equipment, and training so you don't have to.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "Eliminate processing fees entirely with our cash discount program — popular with Layton restaurants, retail, and service businesses looking to protect margins.",
  }
];

const LAYTON_FAQS = [
  {
    q: "Does UBC Unlimited serve businesses in Layton, Utah?",
    a: "Yes — UBC Unlimited serves businesses throughout Layton and Davis County, including the Layton Hills Mall area, the Hill Field Road corridor, and surrounding areas. We offer on-site consultations and local support.",
  },
  {
    q: "How much does merchant services cost for a Layton business?",
    a: "Rates are tailored to your card mix and volume. Most Layton businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a statement review to show your exact savings.",
  },
  {
  ...
  {
    q: "Do you serve businesses near Hill Air Force Base in Layton?",
    a: "Yes — we serve businesses throughout the Layton area including those near Hill Air Force Base, Clearfield, and surrounding Davis County communities.",
  },
  {
    q: "How quickly can a Layton business get approved and start processing?",
    a: "Most Layton businesses are approved and live within 24–48 hours. We handle the setup, equipment, and training so you can focus on running your business.",
  }
];

const LAYTON_NEIGHBORHOODS = [
...
const TESTIMONIALS = [
  {
    name: "Steve B.",
    business: "Retail Store, Layton Hills Area",
    rating: 5,
    text: "UBC Unlimited reviewed our statement and found we were overpaying by over $350 a month. The switch was seamless and the savings are real.",
  },
  {
    name: "Nancy M.",
...
export default function Layton() {
  const schema = {
    ...
    "@type": "LocalBusiness",
    name: "UBC Unlimited — Layton Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout Layton, Utah.",
    url: `https://ubcunlimited.com/locations/layton`,
    ...
    geo: { "@type": "GeoCoordinates", latitude: 41.0602, longitude: -111.9711 },
    areaServed: [
  ...
  return (
    <PageLayout>
      <SEO
        title="Merchant Services Layton, Utah | UBC Unlimited"
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to Layton, Utah businesses. Local support, no contracts*, statement review."
        canonical="/locations/layton"
        schema={schema}
      />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-white/60 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">Layton</span>
              </nav>
              <span className="inline-flex items-center gap-1.5 bg-[#c9a84c]/10 border border-[#c9a84c]/25 text-[#c9a84c] text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-5">
                <MapPin size={11} /> Layton, Utah
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5">
                Merchant Services in{" "}
                <span className="text-[#c9a84c]">Layton</span>
              </h1>
              <p className="text-white/60 text-lg leading-relaxed mb-4 max-w-xl">UBC Unlimited serves Layton businesses with credit card processing, POS systems, cash discount programs, and merchant accounts — with local Utah support that national processors can't match.</p>
              <p className="text-white/70 text-sm leading-relaxed mb-8 max-w-xl">From the Layton Hills Mall retail corridor to the restaurants and service businesses near Hill Air Force Base, we help Davis County businesses accept payments smarter and save on processing costs.</p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="space-y-4">
              <div className="bg-white/4 border border-white/10 rounded-2xl p-6">
                <h2 className="text-white font-bold text-base mb-4 flex items-center gap-2">
                  <MapPin size={16} className="text-[#c9a84c]" />Layton Market Overview
                </h2>
                <div className="grid grid-cols-2 gap-3">
                  {[{ label: "Population", value: "80,000+" },{ label: "County", value: "Davis County" },{ label: "State", value: "Utah" },{ label: "Support", value: "Local Rep" }].map((stat) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#080808] mb-3">Industries We Serve in Layton</h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the Layton market with tailored payment solutions.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {LAYTON_INDUSTRIES.map((industry, i) => (
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Why Layton Businesses Choose UBC Unlimited</h2>
            <p className="text-white/70 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why Layton business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {LAYTON_BENEFITS.map((benefit, i) => (
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-3">Serving Every Neighborhood in Layton</h2>
            <p className="text-gray-600 text-base mb-8">Whether your business is in the heart of Layton or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
            <div className="flex flex-wrap justify-center gap-2.5">
              {LAYTON_NEIGHBORHOODS.map((n) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-2">What Layton Business Owners Say</h2>
            <p className="text-gray-600 text-base">Real feedback from real businesses in the Layton area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Frequently Asked Questions — Layton</h2>
            <p className="text-white/70 text-base">Common questions from Layton business owners about merchant services.</p>
          </div>
          <div className="space-y-3">
            {LAYTON_FAQS.map((faq, i) => (
      ...
      <CTABanner
        title="Ready to Lower Your Processing Costs in Layton?"
        subtitle="Get a statement review and see exactly how much your Layton business can save. Most businesses find meaningful savings on their processing costs after a statement review."
