// American Fork — Dedicated Local SEO Landing Page
// Target keywords: merchant services American Fork, credit card processing American Fork, payment processing American Fork Utah
...
const AMERICAN_FORK_INDUSTRIES = [
  {
    icon: Utensils,
  ...
  },
  {
    ...
    desc: "Law firms, accountants, and consultants in American Fork use our virtual terminals and invoicing to get paid faster.",
    href: "/industries/professional-services",
  },
  {
    icon: Wrench,
    name: "Automotive Services",
    desc: "American Fork auto shops and service centers use our terminals and mobile processing for fast, reliable payment collection.",
    href: "/industries/automotive",
  },
  {
    icon: Stethoscope,
    name: "Medical & Healthcare",
    desc: "American Fork medical practices benefit from HIPAA-aware payment workflows and patient-friendly billing solutions.",
    href: "/industries/medical",
  },
  {
    icon: Wrench,
    name: "Home Services & Contractors",
    desc: "Home service businesses in American Fork use our mobile processing to collect payment on-site, every time.",
    href: "/industries/home-services",
  }
];

const AMERICAN_FORK_BENEFITS = [
  {
    icon: MapPin,
    title: "Truly Local — Utah Based",
    desc: "We're not a national call center. UBC Unlimited serves American Fork businesses with a local rep who knows the market and the unique needs of Utah businesses.",
  },
  {
    icon: TrendingDown,
    title: "Lower Rates Than National Processors",
    desc: "Most American Fork businesses overpay Stripe, Square, or their bank. Our free statement review shows you exactly where you're losing money — and how much you can save.",
  },
  {
    icon: Clock,
    title: "Approved & Processing in 24–48 Hours",
    desc: "Most American Fork businesses are live and processing within one to two business days. We handle the setup, equipment, and training so you don't have to.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "Eliminate processing fees entirely with our cash discount program — popular with American Fork restaurants, retail, and service businesses looking to protect margins.",
  }
];

const AMERICAN_FORK_FAQS = [
  {
    q: "Does UBC Unlimited serve businesses in American Fork, Utah?",
    a: "Yes — UBC Unlimited serves businesses throughout American Fork and Utah County, including downtown, the Geneva Road corridor, and surrounding areas. We offer on-site consultations and local support.",
  },
  {
    q: "How much does merchant services cost for an American Fork business?",
    a: "Rates are tailored to your card mix and volume. Most American Fork businesses qualify for interchange-plus pricing ranging from interchange + 0.10% to 0.50% — significantly lower than Stripe (2.9% + $0.30) or Square (2.6%–3.5%). We offer a free statement review to show your exact savings.",
  },
  {
  ...
  {
    q: "How quickly can an American Fork business get approved and start processing?",
    a: "Most American Fork businesses are approved and live within 24–48 hours. We handle the setup, equipment, and training so you can focus on running your business.",
  },
  {
    q: "Do you serve businesses in Highland and Alpine near American Fork?",
    a: "Yes — we serve the entire northern Utah County area including Highland, Alpine, Cedar Hills, and Pleasant Grove, in addition to American Fork itself.",
  }
];

const AMERICAN_FORK_NEIGHBORHOODS = [
...
const TESTIMONIALS = [
  ...
  {
    name: "Chris M.",
    business: "Auto Shop, American Fork",
    rating: 5,
    text: "We use the mobile reader for on-site payment collection. It's reliable, fast, and our customers love the convenience.",
  },
  {
    name: "Jennifer L.",
    business: "Boutique Retail, American Fork",
    rating: 5,
    text: "The Clover system handles everything — inventory, checkout, and reporting. UBC Unlimited made the transition seamless.",
  }
];
...
export default function AmericanFork() {
  const schema = {
    ...
    "@type": "LocalBusiness",
    name: "UBC Unlimited — American Fork Merchant Services",
    description: "UBC Unlimited provides credit card processing, POS systems, ACH payments, cash discount programs, and merchant services to businesses throughout American Fork, Utah.",
    url: `https://ubcunlimited.com/locations/american-fork`,
    ...
    geo: { "@type": "GeoCoordinates", latitude: 40.3769, longitude: -111.7957 },
    areaServed: [
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="UBC Unlimited provides credit card processing, POS systems, and merchant services to American Fork, Utah businesses. Local support, no contracts, free statement review."
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-white/35 mb-5">
                ...
                <ChevronRight size={12} />
                <span className="text-white/60">American Fork</span>
              </nav>
              <span className="inline-flex items-center gap-1.5 bg-[#c9a84c]/10 border border-[#c9a84c]/25 text-[#c9a84c] text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-5">
                <MapPin size={11} /> American Fork, Utah
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5">
                Merchant Services in{" "}
                <span className="text-[#c9a84c]">American Fork</span>
              </h1>
              <p className="text-white/60 text-lg leading-relaxed mb-4 max-w-xl">UBC Unlimited serves American Fork businesses with credit card processing, POS systems, cash discount programs, and merchant accounts — with local Utah support that national processors can't match.</p>
              <p className="text-white/45 text-sm leading-relaxed mb-8 max-w-xl">From the restaurants and retailers of downtown American Fork to the service businesses along Geneva Road, we help Utah County businesses accept payments smarter and save on processing costs.</p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.15 }} className="space-y-4">
              <div className="bg-white/4 border border-white/10 rounded-2xl p-6">
                <h2 className="text-white font-bold text-base mb-4 flex items-center gap-2">
                  <MapPin size={16} className="text-[#c9a84c]" />American Fork Market Overview
                </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#080808] mb-3">Industries We Serve in American Fork</h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the American Fork market with tailored payment solutions.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {AMERICAN_FORK_INDUSTRIES.map((industry, i) => (
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Why American Fork Businesses Choose UBC Unlimited</h2>
            <p className="text-white/50 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why American Fork business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {AMERICAN_FORK_BENEFITS.map((benefit, i) => (
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-3">Serving Every Neighborhood in American Fork</h2>
            <p className="text-gray-500 text-base mb-8">Whether your business is in the heart of American Fork or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
            <div className="flex flex-wrap justify-center gap-2.5">
              {AMERICAN_FORK_NEIGHBORHOODS.map((n) => (
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#080808] mb-2">What American Fork Business Owners Say</h2>
            <p className="text-gray-500 text-base">Real feedback from real businesses in the American Fork area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Frequently Asked Questions — American Fork</h2>
            <p className="text-white/50 text-base">Common questions from American Fork business owners about merchant services.</p>
          </div>
          <div className="space-y-3">
            {AMERICAN_FORK_FAQS.map((faq, i) => (
      ...
      <CTABanner
        title="Ready to Lower Your Processing Costs in American Fork?"
        subtitle="Get a free statement review and see exactly how much your American Fork business can save. Most businesses save 20–40% on processing fees."
