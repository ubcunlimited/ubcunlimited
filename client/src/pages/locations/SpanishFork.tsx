...
const SPANISH_FORK_INDUSTRIES = [
  {
    ...
    desc: "Spanish Fork's growing dining scene needs reliable POS and payment solutions. We support tableside payments, split checks, and SkyTab systems.",
    href: "/industries/restaurants",
  },
  {
    icon: ShoppingBag,
    name: "Retail & Boutique",
    desc: "Local retailers in Spanish Fork need fast, reliable checkout. We offer Clover and SkyTab retail setups with inventory sync.",
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    rating: 5,
    text: "Switched from Square and saved over $200 a month. The local support is excellent and the SkyTab system is perfect for our operation.",
  },
  {
    name: "Dave T.",
        ...
        <div className="container relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/45 text-sm leading-relaxed mb-8 max-w-xl">From the restaurants and retailers of downtown Spanish Fork to the automotive and manufacturing businesses of this fast-growing Utah County city, we help businesses accept payments smarter and save on processing costs.</p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the Spanish Fork market with tailored payment solutions.</p>
          </div>
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/50 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why Spanish Fork business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-500 text-base mb-8">Whether your business is in the heart of Spanish Fork or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-base">Real feedback from real businesses in the Spanish Fork area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/50 text-base">Common questions from Spanish Fork business owners about merchant services.</p>
          </div>
