...
const PROVO_INDUSTRIES = [
  {
    ...
    desc: "From University Avenue dining to downtown Provo eateries — we support tableside payments, split checks, and Shift4Dine POS built for the Utah dining scene.",
    href: "/industries/restaurants",
  },
  {
    icon: ShoppingBag,
    name: "Retail & Boutique",
    desc: "Independent retailers near BYU and downtown Provo need fast, reliable checkout. We offer Clover and Shift4Dine retail setups with inventory sync.",
        ...
        <div className="container relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/70 text-sm leading-relaxed mb-8 max-w-xl">From the restaurants and retail shops along University Avenue to the tech startups of Silicon Slopes and BYU-area businesses, we help Provo companies accept payments smarter and save on processing costs.</p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-base">UBC Unlimited serves every major industry in the Provo market with tailored payment solutions.</p>
          </div>
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 max-w-2xl mx-auto text-base">There are dozens of payment processors competing for your business. Here's why Provo business owners choose us — and stay with us.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-16 bg-[#f8fafc]">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 text-base mb-8">Whether your business is in the heart of Provo or in one of its surrounding neighborhoods, UBC Unlimited provides on-site consultations and local support.</p>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-base">Real feedback from real businesses in the Provo area.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <section className="py-20 bg-[#080808]">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-white/70 text-base">Common questions from Provo business owners about merchant services.</p>
          </div>
