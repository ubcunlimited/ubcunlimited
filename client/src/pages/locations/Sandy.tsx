...
const SANDY_INDUSTRIES = [
  {
    ...
    desc: "Sandy's State Street and 10600 South retail corridors are among Utah's busiest. We offer Clover and Shift4Dine retail setups with inventory sync.",
    href: "/industries/retail",
  },
  {
    icon: Utensils,
    name: "Restaurants & Food Service",
    desc: "From Sandy's diverse restaurant scene to fast casual near the freeway — we support tableside payments, split checks, and Shift4Dine POS.",
...
export default function Sandy() {
  ...
  return (
    <PageLayout>
      <SEO
        title="Merchant Services Sandy, Utah"
