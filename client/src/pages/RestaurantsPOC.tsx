...
const PAIRS = [
  {
    ...
    solution: "Shift4Dine POS with tableside ordering",
    solutionDetail: "Shift4Dine's tableside handheld terminals let servers take orders and process payments at the table — no waiting for a terminal to free up. Average transaction time drops from 3–4 minutes to under 60 seconds, increasing table turns by up to 20%.",
  ...
  },
  {
    ...
    solutionDetail: "Shift4Dine's visual floor plan shows real-time table status, server assignments, and course timing. Split checks by seat, item, or percentage — in seconds, not minutes. Fewer comps, happier guests, higher tips.",
    solutionTag: "POS Systems",
