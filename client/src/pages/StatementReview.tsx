      ...
      <section className="py-12 bg-[#f8fafc]">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {steps.map((s) => (
              <div key={s.step} className="bg-white rounded-xl p-5 border border-gray-100 text-center">
                <div className="w-10 h-10 rounded-full bg-[#169fa8]/10 text-[#169fa8] font-bold text-lg flex items-center justify-center mx-auto mb-3" style={{ fontFamily: 'Sora, sans-serif' }}>{s.step}</div>
                <h3 className="font-bold text-[#040c1c] mb-1 text-sm" style={{ fontFamily: 'Sora, sans-serif' }}>{s.title}</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <div className="bg-gradient-to-br from-[#040c1c] to-[#0f2040] rounded-2xl p-7 text-white mb-5">
                <TrendingDown size={28} className="text-[#169fa8] mb-3" />
                <h3 className="text-xl font-bold mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>Average Savings</h3>
                <div className="text-4xl font-extrabold text-[#169fa8] mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>$350/mo</div>
              ...
              <form onSubmit={handleSubmit} data-ghl-form="statement-review" className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" required className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#169fa8] focus:ring-2 focus:ring-[#169fa8]/20" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <input type="email" required className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#169fa8] focus:ring-2 focus:ring-[#169fa8]/20" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#040c1c] mb-1.5">Phone *</label>
                  <input type="tel" required className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#169fa8] focus:ring-2 focus:ring-[#169fa8]/20" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#040c1c] mb-1.5">Current Processor</label>
                  <input type="text" className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#169fa8] focus:ring-2 focus:ring-[#169fa8]/20" placeholder="e.g. Square, Stripe, First Data..." />
                </div>
                <div>
                  <label className="block text-sm font-medium text-[#040c1c] mb-1.5">
                    Upload Statement <span className="text-gray-400 font-normal">(optional — you can also email it)</span>
                  </label>
                  <div className="border-2 border-dashed border-gray-200 rounded-lg p-6 text-center hover:border-[#169fa8]/40 transition-colors cursor-pointer">
                ...
                <p className="text-xs text-gray-400 text-center">
                  Your statement is kept strictly confidential. See our <Link href="/legal/privacy-policy" className="text-[#169fa8] hover:underline">Privacy Policy</Link>.
                </p>
              </form>
            </div>
          </div>
