...
const RESULT_CARDS: ResultCard[] = [
  {
    ...
    solution: "UBC Unlimited performed a free statement review, identified excessive interchange downgrades, and implemented a surcharge & cash discount solutions with SkyTab POS. Setup and staff training were completed in a single day.",
