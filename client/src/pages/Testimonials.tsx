...
const RESULT_CARDS: ResultCard[] = [
  {
    ...
    solution: "UBC Unlimited performed a free statement review, identified excessive interchange downgrades, and implemented a surcharging & cash discount program with SkyTab POS. Setup and staff training were completed in a single day.",
