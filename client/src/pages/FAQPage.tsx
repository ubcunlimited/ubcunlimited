    ...
    questions: [
      {
        ...
        answer:
          "We work with you to set up pricing that optimizes your profitability. Depending on your business type and volume, we can structure Flat Rate, Multi-Tiered, or Interchange-Plus pricing. We can also set you up to be compliant for surcharging, cash discounting, or cash discount & surcharging models — all designed to maximize your profits while minimizing the cost to accept payments.",
      },
      {
      ...
      {
        question: "What is cash discount & surcharging and how does it work?",
        answer: (
          <div className="space-y-3">
            ...
            <p>
              <a href="/solutions/dual-pricing" className="text-[#c9a84c] font-semibold hover:underline">Learn more about our Cash Discount & Surcharging &amp; Cash Discount program →</a>
            </p>
          </div>
        ),
      },
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="Answers to common questions about credit card processing, POS systems, ACH payments, cash discount & surcharging, eCommerce, and more. Utah's local merchant services experts."
        canonical="/faq"
        schema={{
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "What credit card processing rates do you offer?", "acceptedAnswer": { "@type": "Answer", "text": "We offer Flat Rate, Multi-Tiered, or Interchange-Plus pricing depending on your business type and volume. We can also set you up for surcharging, cash discounting, or cash discount & surcharging models." } },
