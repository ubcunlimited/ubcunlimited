    ...
    questions: [
      {
        ...
        answer:
          "We work with you to set up pricing that optimizes your profitability. Depending on your business type and volume, we can structure Flat Rate, Multi-Tiered, or Interchange-Plus pricing. We can also set you up to be compliant for surcharging, surcharging & cash discount solutions, or surcharging & cash discount solutions models — all designed to maximize your profits while minimizing the cost to accept payments.",
      },
      {
      ...
      {
        question: "What is surcharging & cash discount solutions and how does it work?",
        answer: (
          <div className="space-y-3">
            ...
            <p>
              <a href="/solutions/dual-pricing" className="text-[#c9a84c] font-semibold hover:underline">Learn more about our Surcharging & Cash Discount Solutions &amp; Cash Discount program →</a>
            </p>
          </div>
        ),
      },
  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="Answers to common questions about credit card processing, POS systems, ACH payments, surcharging & cash discount solutions, eCommerce, and more. Utah's local merchant services experts."
        canonical="/faq"
        schema={{
