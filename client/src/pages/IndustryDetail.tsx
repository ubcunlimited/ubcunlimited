...
const industriesData: IndustryData[] = [
  {
    ...
    faqs: [
      ...
      { question: "Do you offer gift cards and loyalty programs for restaurants?", answer: "Yes. We offer fully integrated gift card and loyalty solutions that work seamlessly with your POS and payment processing. Branded physical and digital gift cards help you acquire new customers — gift card recipients frequently spend more than the card's face value when they redeem it, making each gift card sale both a customer acquisition event and a revenue driver. A points-based loyalty program rewards repeat diners, increases visit frequency, and builds a customer database you can market to directly with email and SMS campaigns. No punch cards, no manual tracking — everything runs automatically at the point of sale." },
