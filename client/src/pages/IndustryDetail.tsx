...
const industriesData: IndustryData[] = [
  {
    ...
    solutions: [
      ...
      { title: "Cash Discount & Surcharging Program", desc: "Eliminate or significantly reduce your credit card processing costs with our compliant cash discount & surcharging program. Display a cash price and a card price at the point of sale — fully legal in Utah and all 50 states — and let your customers choose how they pay." },
    ],
    ...
    faqs: [
      { question: "Can I reduce my credit card processing costs as a restaurant?", answer: "Yes. Our cash discount & surcharging program lets you display a cash price and a card price at the point of sale. Customers who pay by card cover the processing cost, which can effectively eliminate your fees. The program is fully compliant with card network rules, legal in all 50 states, and includes all required signage and staff training. Most restaurant owners see minimal customer pushback when the pricing is displayed clearly upfront. Learn more at our Cash Discount & Surcharging & Cash Discount page." },
  ...
  },
  {
    ...
    solutions: [
      ...
      { title: "Cash Discount & Surcharging Program", desc: "Offset your credit card processing costs with a compliant cash discount & surcharging program. For high-ticket vehicle and service transactions, cash discount & surcharging can represent significant monthly savings — display both a cash and card price at checkout and let customers choose." },
    ],
    ...
    faqs: [
      { question: "Can cash discount & surcharging help reduce processing costs on high-ticket vehicle sales?", answer: "Yes. For dealerships and auto repair shops, cash discount & surcharging can be especially impactful because even a small percentage saved on a $30,000 vehicle transaction adds up quickly. Our cash discount & surcharging program displays both a cash price and a card price at the point of sale — customers who pay by card cover the processing cost. The program is fully compliant with card network rules, legal in all 50 states, and we handle all required signage and setup." },
...
const INDUSTRY_STATS: Record<string, { value: string; label: string }[]> = {
  restaurants: [
    ...
    { value: "$0", label: "Cash Discount & Surcharging Program Fee" },
  ],
  "bars-nightclubs": [
