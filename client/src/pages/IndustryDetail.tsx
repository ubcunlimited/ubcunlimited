...
const industriesData: IndustryData[] = [
  {
    ...
    solutions: [
      ...
      { title: "Cash Discount & Dual Pricing", desc: "Eliminate or significantly reduce your credit card processing costs with our compliant cash discount & dual pricing. Display a cash price and a card price at the point of sale — fully legal in Utah and all 50 states — and let your customers choose how they pay." },
    ],
  ...
  },
  {
    ...
    solutions: [
      ...
      { title: "Cash Discount & Dual Pricing", desc: "Reduce or eliminate your processing costs with a compliant cash discount & dual pricing setup. Post both a cash price and a card price — customers who pay by card cover the fee. Works with your existing POS and requires no monthly fee to participate." },
    ],
    recommendedSolutions: ["/solutions/pos-systems", "/solutions/credit-card-processing", "/solutions/gift-loyalty", "/solutions/surcharge-cash-discount"],
    faqs: [
      { question: "Can I reduce my processing costs as a retail store?", answer: "Yes. Our cash discount & dual pricing is one of the most effective ways for retail stores to offset or eliminate credit card processing fees. You post two prices — a cash price and a card price — and customers who pay by card cover the processing cost. The program is fully compliant, legal in all 50 states, and we provide all required signage and receipt language. Most retailers report minimal impact on customer experience when pricing is clearly displayed." },
  ...
  },
  {
    ...
    solutions: [
      ...
      { title: "Cash Discount & Dual Pricing", desc: "Offset your credit card processing costs with a compliant cash discount & dual pricing. For high-ticket vehicle and service transactions, cash discount & dual pricing can represent significant monthly savings — display both a cash and card price at checkout and let customers choose." },
    ],
    recommendedSolutions: ["/solutions/credit-card-processing", "/solutions/virtual-terminals", "/solutions/ach-echeck-processing", "/solutions/surcharge-cash-discount"],
    faqs: [
      { question: "Can cash discount & dual pricing help reduce processing costs on high-ticket vehicle sales?", answer: "Yes. For dealerships and auto repair shops, cash discount & dual pricing can be especially impactful because even a small percentage saved on a $30,000 vehicle transaction adds up quickly. Our cash discount & dual pricing displays both a cash price and a card price at the point of sale — customers who pay by card cover the processing cost. The program is fully compliant with card network rules, legal in all 50 states, and we handle all required signage and setup." },
  ...
  },
  {
    ...
    recommendedSolutions: ["/solutions/high-risk-processing", "/solutions/ecommerce-payments", "/solutions/credit-card-processing", "/solutions/surcharge-cash-discount"],
    faqs: [
  ...
  },
  {
    ...
    description: "Adult entertainment is one of the most restricted categories in payment processing. Following the 2020 policy changes by Visa and Mastercard, most mainstream processors exited the adult content category entirely, leaving platforms, studios, and subscription sites scrambling for stable merchant accounts. The compliance requirements are strict: age verification, content moderation, CSAM prevention policies, and specific billing descriptor standards are all mandatory for any processor willing to work in this space.\n\nUBC Unlimited works with specialized acquiring banks that remain active in the adult entertainment category and have the compliance infrastructure to support adult content platforms, subscription sites, live streaming businesses, and adult retail operations. We understand the unique challenges of this market — from managing chargeback exposure on subscription billing to configuring discreet billing descriptors that minimize customer confusion and friendly fraud.\n\nOur acquiring bank partners have built their underwriting processes specifically around the compliance requirements of adult merchants. That means faster approvals for businesses that have their documentation in order, more stable long-term accounts, and dedicated support from teams that understand your industry. We do not work with businesses that produce or distribute illegal content — all applicants are reviewed for compliance with applicable laws and card network policies before approval.\n\nDue to the extensive compliance review required for this category, approval typically takes 5–7 business days. We guide you through every step of the application process and help you prepare the documentation required by the acquiring bank.",
    challenges: [
  ...
  },
  {
    ...
    description: "Subscription and continuity businesses — including membership programs, box subscriptions, SaaS platforms, and free-trial-to-paid offers — face heightened scrutiny from payment processors due to elevated chargeback rates and consumer protection concerns. Customers who forget they subscribed, dispute recurring charges as unauthorized, or struggle to cancel are the primary driver of chargebacks in this category. Card networks have responded with strict disclosure requirements and chargeback thresholds that can result in account termination if exceeded.\n\nUBC Unlimited provides compliant recurring billing infrastructure and high-risk merchant accounts that support the full lifecycle of subscription commerce. We work with processors who specialize in subscription billing and have the tools to help you manage chargeback risk proactively — including pre-billing notifications, easy cancellation flows, account updater services, and real-time chargeback alerts via Ethoca and Verifi.\n\nFree-trial-to-paid conversion models require particular attention to Visa and Mastercard compliance rules. Both networks require clear disclosure of trial terms, a reminder notification before the first post-trial charge, and easy cancellation options. Non-compliance can result in fines and account termination. We help you design billing flows that meet these requirements from day one.\n\nFor established subscription businesses with clean processing history, we can often negotiate favorable rates and reduced reserve requirements. For newer businesses or those with elevated chargeback ratios, we provide a structured path to account stability with the monitoring and prevention tools to get there. Due to the specialized underwriting required for this category, approval typically takes 5–7 business days.",
    challenges: [
  ...
  },
  {
    ...
    description: "Licensed online pharmacies and telehealth prescription services face some of the most challenging payment processing environments of any industry. The category has been heavily abused by fraudulent operations selling counterfeit or unapproved medications without valid prescriptions, causing card networks and most processors to apply extreme caution — or outright prohibition — to all pharmacy accounts, regardless of licensing status.\n\nUBC Unlimited works exclusively with licensed, compliant online pharmacies and connects them with processors who have the expertise to evaluate legitimate pharmacy businesses. Our acquiring bank partners understand the regulatory framework: state pharmacy board licensing, NABP VIPPS accreditation, DEA registration for controlled substances, and the telehealth practice laws that govern prescription issuance. We do not work with unlicensed or non-compliant operations.\n\nFor telehealth platforms that include prescription fulfillment, the underwriting process examines both the consultation side and the pharmacy fulfillment side of the business. Platforms that can demonstrate licensed physician oversight, proper prescription workflows, and compliant pharmacy partnerships are well-positioned for approval.\n\nCompounding pharmacies — both 503A and 503B facilities — have their own distinct underwriting requirements and we work with processors experienced in both categories. ACH and eCheck processing is also available as an alternative payment method for patients who prefer bank transfers for healthcare purchases.\n\nDue to the extensive compliance review required for this category, approval typically takes 5–7 business days. We guide you through the full documentation process and advocate on your behalf with our acquiring bank partners.",
    challenges: [
      "Near-universal rejection from standard processors",
...
const INDUSTRY_STATS: Record<string, { value: string; label: string }[]> = {
  restaurants: [
    ...
    { value: "$0", label: "Cash Discount & Dual Pricing Fee" },
  ],
  "bars-nightclubs": [
