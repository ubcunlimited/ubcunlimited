...
const industriesData: IndustryData[] = [
  {
    ...
    solutions: [
      ...
      { title: "Surcharge & Cash Discount Solutions", desc: "Eliminate or significantly reduce your credit card processing costs with our compliant surcharge & cash discount solutions. Display a cash price and a card price at the point of sale — fully legal in Utah and all 50 states — and let your customers choose how they pay." },
    ],
    ...
    faqs: [
      { question: "Can I reduce my credit card processing costs as a restaurant?", answer: "Yes. Our surcharge & cash discount solutions lets you display a cash price and a card price at the point of sale. Customers who pay by card cover the processing cost, which can effectively eliminate your fees. The program is fully compliant with card network rules, legal in all 50 states, and includes all required signage and staff training. Most restaurant owners see minimal customer pushback when the pricing is displayed clearly upfront. Learn more at our Surcharge & Cash Discount Solutions page." },
  ...
  },
  {
    ...
    solutions: [
      ...
      { title: "Surcharge & Cash Discount Solutions", desc: "Reduce or eliminate your processing costs with a compliant surcharge & cash discount setup. Post both a cash price and a card price — customers who pay by card cover the fee. Works with your existing POS and requires no monthly fee to participate." },
    ],
    recommendedSolutions: ["/solutions/pos-systems", "/solutions/credit-card-processing", "/solutions/gift-loyalty", "/solutions/surcharge-cash-discount"],
    faqs: [
      { question: "Can I reduce my processing costs as a retail store?", answer: "Yes. Our surcharge & cash discount solutions is one of the most effective ways for retail stores to offset or eliminate credit card processing fees. You post two prices — a cash price and a card price — and customers who pay by card cover the processing cost. The program is fully compliant, legal in all 50 states, and we provide all required signage and receipt language. Most retailers report minimal impact on customer experience when pricing is clearly displayed." },
  ...
  },
  {
    ...
    solutions: [
      ...
      { title: "Surcharge & Cash Discount Solutions", desc: "Offset your credit card processing costs with a compliant surcharge & cash discount solutions. For high-ticket vehicle and service transactions, surcharge & cash discount solutions can represent significant monthly savings — display both a cash and card price at checkout and let customers choose." },
    ],
    ...
    faqs: [
      { question: "Can surcharge & cash discount solutions help reduce processing costs on high-ticket vehicle sales?", answer: "Yes. For dealerships and auto repair shops, surcharge & cash discount solutions can be especially impactful because even a small percentage saved on a $30,000 vehicle transaction adds up quickly. Our surcharge & cash discount solutions displays both a cash price and a card price at the point of sale — customers who pay by card cover the processing cost. The program is fully compliant with card network rules, legal in all 50 states, and we handle all required signage and setup." },
...
const INDUSTRY_STATS: Record<string, { value: string; label: string }[]> = {
  restaurants: [
    ...
    { value: "$0", label: "Surcharge & Cash Discount Solutions Fee" },
  ],
  "bars-nightclubs": [
