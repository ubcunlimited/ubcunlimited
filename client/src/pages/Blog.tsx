  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="Expert articles on credit card processing, POS systems, payment gateways, surcharging & cash discount solutions, surcharging, and merchant services tips for Utah business owners."
        canonical="/blog"
      />
