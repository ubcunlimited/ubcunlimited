...
const inputClass = "w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-[#c9a84c] focus:ring-2 focus:ring-[#c9a84c]/20 transition-all text-[#080808] placeholder-gray-400";
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-[#080808] mb-6" style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}>Get in Touch</h2>
                ...
                {[
                  ...
                  <div key={item.label} className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      {item.href ? (
                        <a href={item.href} className="text-[#080808] font-semibold hover:text-[#c9a84c] transition-colors">{item.value}</a>
                      ) : (
                        <div className="text-[#080808] font-semibold">{item.value}</div>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-[#f7f3ec] rounded-xl p-5 border border-gray-100 mb-5">
                <h3 className="font-bold text-[#080808] mb-2">Prefer a free consultation?</h3>
              ...
              <div className="bg-[#f7f3ec] rounded-xl p-5 border border-gray-100">
                <h3 className="font-bold text-[#080808] mb-2">Free Statement Review</h3>
            ...
            <div>
              {submitted ? (
                <div className="bg-[#c9a84c]/10 border border-[#c9a84c]/20 rounded-2xl p-10 text-center">
                  ...
                  <h3 className="text-xl font-bold text-[#080808] mb-2" style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}>Message Received!</h3>
                ...
                <form onSubmit={handleSubmit} data-ghl-form="contact" className="space-y-4">
                  <h2 className="text-xl font-bold text-[#080808] mb-2" style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}>Send Us a Message</h2>
                  ...
                  <div className="flex items-start gap-3 pt-1">
                    <input
                      ...
                      className="mt-0.5 h-4 w-4 shrink-0 rounded border-gray-300 accent-[#c9a84c] cursor-pointer"
                    />
                    <label htmlFor="sms_transactional" className={smsConsentLabelClass}>
                      ...
                      <Link href="/legal/privacy-policy" className="underline hover:text-[#c9a84c] transition-colors">Privacy Policy</Link>{" "}and{" "}
                      <Link href="/legal/terms-of-service" className="underline hover:text-[#c9a84c] transition-colors">Terms of Service</Link>.
                    </label>
                  </div>
