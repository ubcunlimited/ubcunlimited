...
export const SOLUTION_PAIRS: Record<string, SolutionChallengePair[]> = {
  ...
  "pos-systems": [
    {
      ...
      solution: "Shift4Dine POS — built for high-volume environments",
      solutionDetail: "Shift4Dine is engineered for reliability in demanding restaurant and retail environments. 4G LTE backup keeps you processing even when your internet goes down. Lifetime hardware warranty means you're never stuck with a broken terminal.",
      solutionTag: "Shift4Dine POS",
    ...
    },
    {
      ...
      solutionDetail: "Shift4Dine's pricing is designed to scale without punishing growth. Add terminals and locations without the per-unit fees that make other systems cost-prohibitive as you expand.",
    ...
    },
    {
      ...
      solutionDetail: "Monitor sales, inventory levels, and staff performance from anywhere via the Shift4Dine mobile app. Real-time dashboards show you what's selling, what's not, and where your busiest hours are.",
  ...
  "surcharge-cash-discount": [
    ...
    {
      challenge: "Uncertainty about whether cash discount & dual pricing are legal and compliant",
      ...
      solutionDetail: "Our cash discount & dual pricing are fully compliant with Visa, Mastercard, and Discover rules, and legal in all 50 states. We handle the setup, signage, and compliance documentation so you don't have to worry.",
      solutionTag: "Compliance",
      impact: "Zero compliance risk",
    },
    {
      challenge: "Your current POS doesn't support cash discount & dual pricing",
      challengeDetail: "Implementing cash discount & dual pricing requires a POS that can display both prices, print compliant receipts, and report correctly — not all systems support this.",
      solution: "Dual-pricing-ready POS and terminal hardware",
      solutionDetail: "We supply terminals and POS systems pre-configured for cash discount & dual pricing. Customer-facing screens show both prices clearly, receipts are compliant, and reporting separates cash and card transactions automatically.",
