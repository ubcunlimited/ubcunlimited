...
export const SOLUTION_PAIRS: Record<string, SolutionChallengePair[]> = {
  ...
  "credit-card-processing": [
    ...
    {
      challenge: "Surprise fees and billing you don't understand",
      challengeDetail: "Monthly statements from large processors are intentionally complex — PCI fees, batch fees, statement fees, and dozens of line items that obscure your true cost.",
      solution: "Transparent, itemized pricing with no hidden fees",
      solutionDetail: "We provide a clear breakdown of every fee before you sign anything. No surprise charges, no annual fee increases, no confusing line items. What we quote is what you pay.",
      solutionTag: "Transparent Pricing",
      impact: "No billing surprises",
    },
    {
      ...
      solutionDetail: "We offer flexible contract terms and work hard to earn your business every month. If you're ever unhappy, we'll work to fix it — not hold you hostage.",
  ...
  "dual-pricing": [
    ...
    {
      challenge: "Uncertainty about whether surcharging & cash discount solutions is legal and compliant",
      ...
      solutionDetail: "Our surcharging & cash discount program is fully compliant with Visa, Mastercard, and Discover rules, and legal in all 50 states. We handle the setup, signage, and compliance documentation so you don't have to worry.",
      solutionTag: "Compliance",
      impact: "Zero compliance risk",
    },
    {
      challenge: "Your current POS doesn't support surcharging & cash discount solutions",
      challengeDetail: "Implementing surcharging & cash discount solutions requires a POS that can display both prices, print compliant receipts, and report correctly — not all systems support this.",
      solution: "Dual-pricing-ready POS and terminal hardware",
      solutionDetail: "We supply terminals and POS systems pre-configured for surcharging & cash discount solutions. Customer-facing screens show both prices clearly, receipts are compliant, and reporting separates cash and card transactions automatically.",
  ...
  "ach-processing": [
    {
      ...
      solutionDetail: "ACH transfers typically cost $0.25–$1.50 per transaction regardless of amount — compared to 2–3% for credit cards. On a $2,000 rent payment, that's $40–$60 saved per transaction.",
    ...
    },
    {
      ...
      solutionDetail: "ACH transfers include bank account verification that reduces the risk of returned transactions. Funds are typically available within 1–2 business days, faster than waiting for a check to clear.",
