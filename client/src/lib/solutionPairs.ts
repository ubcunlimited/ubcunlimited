...
export const SOLUTION_PAIRS: Record<string, SolutionChallengePair[]> = {
  ...
  "dual-pricing": [
    ...
    {
      challenge: "Uncertainty about whether dual pricing is legal and compliant",
      ...
      solutionDetail: "Our dual pricing program is fully compliant with Visa, Mastercard, and Discover rules, and legal in all 50 states. We handle the setup, signage, and compliance documentation so you don't have to worry.",
      solutionTag: "Compliance",
      impact: "Zero compliance risk",
    },
    {
      challenge: "Your current POS doesn't support dual pricing",
      challengeDetail: "Implementing dual pricing requires a POS that can display both prices, print compliant receipts, and report correctly — not all systems support this.",
      solution: "Dual-pricing-ready POS and terminal hardware",
      solutionDetail: "We supply terminals and POS systems pre-configured for dual pricing. Customer-facing screens show both prices clearly, receipts are compliant, and reporting separates cash and card transactions automatically.",
